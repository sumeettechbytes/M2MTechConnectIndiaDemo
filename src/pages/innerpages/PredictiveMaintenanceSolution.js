...
const EventData = [
    {
        ...
        "image": "predictive-maintenance-solution.webp",
        ...
        <>
            ...
            <Layout>
                <BreadcrumbOne 
                    ...
                    currentUrl="Predictive Maintenance Solution"
                />
                            ...
                            <div className="col-lg-7">
                                <div className="content">
                                    ...
                                    <p>
                                        ...
                                        The goal of this project is to build a predictive maintenance solution using Deep Learning. This will involve several steps including but not limited to:
                                    </p>
                                    <ul>
                                        <li>
                                            Analyzing existing data related to the company's advanced manufacturing processes.
                                        </li>
                                        <li>
                                            Extracting right features automatically using Deep Learning.
                                        </li>
                                        <li>
                                            Generate labels, perform Data Preprocessing, apply normalization.
                                        </li>
                                        <li>
                                            Handle Imbalanced Data using relevant techniques.
                                        </li>
                                        <li>
                                            Developing a predictive maintenance model using Deep Learning.
                                        </li>
                                        <li>
                                            Optimizing model performance and assessing areas for improvement.
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            Understanding of Advanced Manufacturing processes and data.
                                        </li>
                                        <li>
                                            Understanding of variables that affect the accuracy of the predictive maintenance model.
                                        </li>
                                        <li>
                                            Identification of areas for future improvement of the model.
                                        </li>
                                        <li>
                                            Testing the developed model with data and accounting for additional parameters.
                                        </li>
                                    </ul>
                                    <p>
                                    ...
                                    <ul>
                                        <li>
                                            Predictive maintenance models and data analysis.
                                        </li>
                                        <li>
                                            Python, Neural Network, Classification, Regression, Machine learning.
                                        </li>
                                        <li>
