...
const EventData = [
    {
        ...
        "image": "housing-market-price-prediction.webp",
        ...
        <>
            ...
            <Layout>
                <BreadcrumbOne 
                    ...
                    currentUrl="Housing Market Price Prediction"
                />
                            ...
                            <div className="col-lg-7">
                                <div className="content">
                                    ...
                                    <p>
                                        ...
                                        The goal of this project is to create a housing market price prediction using regression supervised learning. This will involve several steps including but not limited to:
                                    </p>
                                    <ul>
                                        <li>
                                            Analyzing existing housing market data.
                                        </li>
                                        <li>
                                            Developing a supervised learning model to predict housing market prices.
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            Understanding of existing housing market data.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            Testing the model with users and accounting for additional parameters.
                                        </li>
                                    </ul>
                                    <p>
