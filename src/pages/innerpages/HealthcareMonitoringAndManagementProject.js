...
const EventData = [
    {
        ...
        "image": "healthcare-monitoring-and-management-project.webp",
        ...
        <>
            ...
            <Layout>
                <BreadcrumbOne 
                    ...
                    currentUrl="Healthcare Monitoring and Management Project"
                />
                            ...
                            <div className="col-lg-7">
                                <div className="content">
                                    ...
                                    <p>
                                        ...
                                        The goal of this project is to create a Healthcare Monitoring and Management system that uses IoT devices such as wearables, medical sensors and connected healthcare systems to collect patient data using Deep Learning. This will involve several steps including but not limited to:
                                    </p>
                                    <ul>
                                        <li>
                                            Analyzing existing datasets related to healthcare and patient data.
                                        </li>
                                        <li>
                                            Developing a deep learning model to collect and process patient data.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            Accounting for additional variables in the deep learning model.
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            Understanding of existing datasets related to healthcare and patient data.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            Testing the developed model with patients and accounting for additional parameters.
                                        </li>
                                    </ul>
                                    <p>
