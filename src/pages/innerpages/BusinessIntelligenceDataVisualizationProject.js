...
const EventData = [
    {
        ...
        "image": "business-intelligence-data-visualization-project.webp",
        ...
        <>
            ...
            <Layout>
                <BreadcrumbOne 
                    ...
                    currentUrl="Business Intelligence Data Visualization Project"
                />
                            ...
                            <div className="col-lg-7">
                                <div className="content">
                                    ...
                                    <p>
                                        ...
                                        The goal of this project is to identify patterns and trends in the available dataset. This will involve several steps including but not limited to:
                                    </p>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            Developing data visualizations to identify patterns and trends.
                                        </li>
                                        <li>
                                            Optimizing data visualization performance and assessing areas for improvement.
                                        </li>
                                        <li>
                                            Researching other variables that can improve the quality of data visualizations.
                                        </li>
                                        <li>
                                            Accounting for additional variables in the data visualizations.
                                        </li>
                                        <li>
                                            Testing the developed data visualizations and making improvements based on additional data.
                                        </li>                                        
                                    </ul>
                                    <p>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            Understanding of variables that affect the quality of data visualizations.
                                        </li>
                                        <li>
                                            Identification of areas for future improvement of the data visualizations.
                                        </li>
                                        <li>
                                            Testing the developed data visualizations with users and accounting for additional parameters.
                                        </li>
                                    </ul>
                                    <p>
