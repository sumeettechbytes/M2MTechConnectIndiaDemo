...
const EventData = [
    {
        ...
        "image": "medical-diagnosis-project.webp",
        ...
        <>
            ...
            <Layout>
                <BreadcrumbOne 
                    ...
                    currentUrl="Medical Diagnosis Project"
                />
                            ...
                            <div className="col-lg-7">
                                <div className="content">
                                    ...
                                    <p>
                                        ...
                                        The main goal of this project is to create a medical diagnosis system using classification supervised learning. This system will be used to accurately diagnose medical conditions based on patient data. This will involve several steps including but not limited to:
                                    </p>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            Developing a classification supervised learning algorithm.
                                        </li>
                                        <li>
                                            Training the algorithm using the patient data.
                                        </li>
                                        <li>
                                            Testing the algorithm to ensure accuracy.
                                        </li>
                                        <li>
                                            Optimizing the algorithm for improved accuracy.
                                        </li>
                                    </ul>
                                    <p>
                                    ...
                                    <ul>
                                        <li>
                                            Understanding of classification supervised learning algorithms.
                                        </li>
                                        <li>
                                            Ability to collect and analyze patient data.
                                        </li>
                                        <li>
                                            Ability to develop and train a classification supervised learning algorithm.
                                        </li>
                                        <li>
                                            Ability to test and optimize the algorithm for improved accuracy.
                                        </li>
                                    </ul>
                                    <p>
