            ...
            <div className="container eduvibe-animated-shape">
                ...
                <div className="shape-dot-wrapper shape-wrapper d-xl-block d-none">
                    <div className="shape-image shape-image-1">
                        <img src={process.env.PUBLIC_URL+"/images/shapes/shape-11-07.png"} alt="Shape Thumb" />
                    </div>
                    <div className="shape-image shape-image-2">
                        <img src={process.env.PUBLIC_URL+"/images/shapes/shape-01-02.png"} alt="Shape Thumb" />
                    </div>
                    <div className="shape-image shape-image-3">
                        <img src={process.env.PUBLIC_URL+"/images/shapes/shape-03.png"} alt="Shape Thumb" />
                    </div>
                    <div className="shape-image shape-image-4">
                        <img src={process.env.PUBLIC_URL+"/images/shapes/shape-13-12.png"} alt="Shape Thumb" />
                    </div>
                    <div className="shape-image shape-image-5">
                        <img src={process.env.PUBLIC_URL+"/images/shapes/shape-36.png"} alt="Shape Thumb" />
                    </div>
                    <div className="shape-image shape-image-6">
                        <img src={process.env.PUBLIC_URL+"/images/shapes/shape-05-07.png"} alt="Shape Thumb" />
                    </div>
                </div>
            </div>
        </div>
