...
const items = [
  {
    ...
    info: 'AgTech optimizes farming practices to increase crop yields and meet the growing global food demand.',
    icon: 'icon-award-line'
  },
  {
    title: 'Resource Efficiency',
    info: 'AgTech conserves water, energy, and other resources, reducing the environmental impact of agriculture.',
    icon: 'icon-user-2'
  },
  {
    title: 'Precision Farming',
    info: 'AgTech enables precise field-level management, improving crop health and reducing waste.',
    icon: 'icon-eye-line'
  },
  {
    title: 'Supply Chain Transparency',
    info: 'AgTech enhances traceability, ensuring food safety and quality throughout the supply chain.',
    icon: 'icon-award-line'
  },
  {
    title: 'Pest and Disease Management',
    info: 'AgTech provides early detection and control measures for pests and diseases, safeguarding crops.',
    icon: 'icon-user-2'
  },
  {
    title: 'Climate Resilience',
    info: 'AgTech solutions help farmers adapt to climate change by providing weather data and predictive analytics for informed decision-making.',
    icon: 'icon-eye-line'
  }
];

const AgTechHowItHelps = () => {
  return (
    <>
      <Element
        name="what-we-do-two"
            ...
            <div className="col-lg-6">
              <div className="inner">
                <ProgramsSectionTitle
                  slogan = "How It Helps"
                  title = "What Problems AgTech Solves?"
                />
                <ScrollAnimation 
                  animateIn="fadeInUp"
...
export default AgTechHowItHelps;