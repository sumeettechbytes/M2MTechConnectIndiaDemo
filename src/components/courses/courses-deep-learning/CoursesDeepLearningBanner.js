...
const CoursesDeepLearningBanner = () => {
    ...
    return (
        <div className="deep-learning-banner banner-style-1 banner-style-students-spotlight bg-image height-640 d-flex align-items-center">
                        ...
                        <div className="banner-left-content">
                            <div className="inner">
                                <div className="content">
                                    <h1 className="title">Deep Learning</h1>
                                    <p className="description">Join a cohort to learn to design artificial neural networks to model and solve complex problems. Get hands-on project experience.</p>
...
export default CoursesDeepLearningBanner;