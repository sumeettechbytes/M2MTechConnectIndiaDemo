...
const CoursesCodingBanner = () => {
    ...
    return (
        <div className="coding-banner banner-style-1 banner-style-students-spotlight bg-image height-640 d-flex align-items-center">
                ...
                <div className="row g-5 row--40 align-items-center">
                        ...
                        <div className="banner-left-content">
                            <div className="inner">
                                <div className="content">
                                    ...
                                    <p className="description">Join a cohort to learn the science of turning code into softwares. Get hands-on project experience.</p>
                    ...
                    <div className="order-2 order-xl-3 col-lg-12 col-xl-5 d-flex flex-column align-items-start justify-content-center banner-right-content">
                        ...
                        <div className="banner-feature mt-4" id="BannerFeature2">
                            ...
                            <div className="feature-content">
                                <p className="feature-description">Hands-on Projects</p>
                            </div>
                        </div>
                        ...
                        <div className="banner-feature mt-4" id="BannerFeature4">
                            ...
                            <div className="feature-content">
                                <p className="feature-description">No Code to IDE Progression</p>
                            </div>
                        </div>
...
export default CoursesCodingBanner;