...
import CoursesCodingPastStudentsProjectsCarousel from './past-students-projects/CoursesCodingPastStudentsProjectsCarousel';

const CoursesCodingPastStudentsProjects = () => {
    return (
        <Element
            name="what-we-do-one"
                ...
                <div className="row g-5 align-items-center">
                    <div className="col-12">
                        <div className="inner mt-md-16">
                            ...
                            <CoursesCodingPastStudentsProjectsCarousel />
...
export default CoursesCodingPastStudentsProjects;