...
import CoursesDesignPastStudentsProjectsCarousel from './past-students-projects/CoursesDesignPastStudentsProjectsCarousel';

const CoursesDesignPastStudentsProjects = () => {
    return (
        <Element
            name="what-we-do-one"
                ...
                <div className="row g-5 align-items-center">
                    <div className="col-12">
                        <div className="inner mt-md-16">
                            ...
                            <CoursesDesignPastStudentsProjectsCarousel />
...
export default CoursesDesignPastStudentsProjects;