...
const CoursesDesignBanner = () => {
    ...
    return (
        <div className="design-banner banner-style-1 banner-style-students-spotlight bg-image height-640 d-flex align-items-center">
                        ...
                        <div className="banner-left-content">
                            <div className="inner">
                                <div className="content">
                                    ...
                                    <p className="description">Join a cohort to learn to design a website or mobile app. Get hands-on project experience.</p>
...
export default CoursesDesignBanner;