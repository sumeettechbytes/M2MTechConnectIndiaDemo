...
const accordionItems = [
    {
        id: 1,
        title: 'How long is the machine learning course?',
    ...
    },
    {
        ...
        body: '<p>Prior experience in software engineering/data science.<br></br>OR advanced knowledge of Python, statistics, linear algebra, and calculus</p>'
    },
    {
        id: 4,
        title: 'Is this program right for you?',
        body: '<p>This machine learning bootcamp is designed for people with strong software engineering skills and industry experience, who want to become machine learning engineers.</p>'
    },
];
...
const CoursesMachineLearningFAQ = () => {
...
export default CoursesMachineLearningFAQ;