...
const CoursesMachineLearningBanner = () => {
    ...
    return (
        <div className="machine-learning-banner banner-style-1 banner-style-students-spotlight bg-image height-640 d-flex align-items-center">
                        ...
                        <div className="banner-left-content">
                            <div className="inner">
                                <div className="content">
                                    <h1 className="title">Machine Learning</h1>
                                    <p className="description">Join a cohort to learn to give computers the ability to learn without being explicitly programmed. Get hands-on project experience.</p>
                    ...
                    <div className="order-2 order-xl-3 col-lg-12 col-xl-5 d-flex flex-column align-items-start justify-content-center banner-right-content">
                        <div className="banner-feature mt-4" id="BannerFeature1">
                            ...
                            <div className="feature-content">
                                <p className="feature-description">Comprehensive Curriculum</p>
                            </div>
                        </div>
                        <div className="banner-feature mt-4" id="BannerFeature2">
                            ...
                            <div className="feature-content">
                                <p className="feature-description">Real-world Projects</p>
                            </div>
                        </div>
                        <div className="banner-feature mt-4" id="BannerFeature3">
                            ...
                            <div className="feature-content">
                                <p className="feature-description">Expert Mentorship</p>
                            </div>
                        </div>
...
export default CoursesMachineLearningBanner;