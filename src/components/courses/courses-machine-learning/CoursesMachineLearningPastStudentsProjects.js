...
import CoursesMachineLearningPastStudentsProjectsCarousel from './past-students-projects/CoursesMachineLearningPastStudentsProjectsCarousel';

const CoursesMachineLearningPastStudentsProjects = () => {
    return (
        <Element
            name="what-we-do-one"
                ...
                <div className="row g-5 align-items-center">
                    <div className="col-12">
                        <div className="inner mt-md-16">
                            ...
                            <CoursesMachineLearningPastStudentsProjectsCarousel />
...
export default CoursesMachineLearningPastStudentsProjects;