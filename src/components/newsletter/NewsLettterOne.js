                    ...
                    <div className="col-lg-12">
                        <div className="inner text-center">
                            ...
                            <div className="newsletter-form newsletter-form-style-1 mt--60">
                                <form
                                    action="https://formspree.io/f/xlekeqld"
                                    method="POST"
                                    className="input-box">
                                    <input type="text" name="source" readOnly value="m2m tech connect newsletter subscription" style={{display: "none"}} />
                                    <input type="email" name="email" placeholder="Enter your mail address" />
                                    <div className="mail-icon">
                                        <i className="icon-mail-open-line"></i>
                                    </div>
                                    <button type="submit" className="send-button"><i className="icon-send-plane-fill"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>
